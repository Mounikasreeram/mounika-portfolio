  ...
  return (
    <div>
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        <p className="text-sm text-[#d3d8e8]">{"If you would like to discuss frontend engineering, design systems, enterprise web applications, or collaboration opportunities, please reach out."}</p>
